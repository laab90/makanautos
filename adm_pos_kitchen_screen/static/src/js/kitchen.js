    ...
    var KitchenKanban = AbstractAction.extend({
        ...
        load_data: function () {
            ...
            self._rpc({
                ...
                args: [[
                    ...
                    ['kitchen_state', 'full_product_name', 'qty', 'order_id', 'product_id', 'avg_completion_time', 'note']
                ],
            }).then(function(lines) {
                self._rpc({
                    model: 'pos.order',
        ...
        _onShowReceipie: function (ev) {
            ...
            this._rpc({
                ...
                var html_data = '<div class="icon-close-container"><span class="icon-close">X</span></div>';
