...
class AccountMove(models.Model):
    ...
    gt_dte_serie_tr = fields.Char('Serie', required=False, copy=False, tracking=True)
    gt_dte_number_tr = fields.Char('Numero DTE', required=False, copy=False, Trecking=True)
