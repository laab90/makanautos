odoo.define('pos_invoice_fel_reprints.pos_invoice_fel_reprints', function (require) {
"use strict";
        ...
        print_order_invoice(order_id){
            ...
            this.rpc({
                ...
                var order = {
                    ...
                    console.log('******************order************************')
                    console.log(order)
                    const report = self.env.qweb.renderToString('PosFelTicket', order);
                    self.showTempScreen('RePrintBillScreenWidget', {"report": report});
                    self.trigger('close-popup');
            });
