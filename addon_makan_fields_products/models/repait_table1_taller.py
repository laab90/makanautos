...
class RepairOrderLine(models.Model):
    _name = 'repair.order.table1.taller'

    order_id_taller1 = fields.Many2one('repair.order', string="Orden de Reparación")
    one2manyproducttaller1 = fields.Char(string="Trabajo")
    one2manycantidadtaller1 = fields.Float(string="Horas")
    display_type = fields.Selection([
        ('line_section', "Sección"),
        ('line_note', "Nota")
    ], default=False, help="Usar para definir la sección de una orden.")

    nota_taller1 = fields.Text(string="Nota Taller")
