odoo.define('Partner_ageing_book.ageing', function (require) {
    'use strict';
        ...
        load_data: function (initial_render = true) {
            ...
            self._rpc({
                ...
                var action = {
                    ...
                    'report_name': 'Partner_ageing_book.partner_ageing',
                    'report_file': 'Partner_ageing_book.partner_ageing',
                    'data': {
                        'report_data': data
                    },
                    'context': {
                    ...
                    'display_name': 'Vencidos por pagar/cobrar',
                };
...
//                    'type': 'ir_actions_dynamic_xlsx_download',
                    'data': {
                         ...
                         'report_name': 'Vencido por pagar/cobrar',
