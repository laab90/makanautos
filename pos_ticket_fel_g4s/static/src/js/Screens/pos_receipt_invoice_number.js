odoo.define('pos_ticket_fel_g4s.pos_receipt_invoice_number', function (require){
    'use_strict';
      ...
      const PosInvPaymentScreen = (PaymentScreen) =>
          class extends PaymentScreen {
              ...
              async _finalizeValidation() {
                  ...
                  var fields = ['account_move', 'is_fel', 'fel_serie', 'fel_number', 'fel_date', 'fel_uuid', 'customer_vat', 'customer_name', 'customer_street', 'company_name', 'company_branch_name', 'company_address', 'active_contingencia', 'no_acceso', 'fel_type'];
                  ...
                  if (this.currentOrder.is_to_invoice()) {
                      ...
                      .then(function (output) {
                          ...
                          var fel_type = output[0]['fel_type']
                          ...
                          self.currentOrder.fel_type = fel_type
                          //Customer information
