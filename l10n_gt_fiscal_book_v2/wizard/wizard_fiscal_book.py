...
class WizardVentasCompras(models.TransientModel):
    ...
    def print_report_sale(self):
        ...
        return self.env.ref('l10n_gt_fiscal_book_v2.report_sale_fiscal_book').report_action(self, data=datas)
    ...
    def print_report_purchase(self):
        ...
        return self.env.ref('l10n_gt_fiscal_book_v2.report_purchase_fiscal_book').report_action(self, data=datas)
